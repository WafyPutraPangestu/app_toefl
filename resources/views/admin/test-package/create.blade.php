<x-layout>
    ...
    <div x-data="{
        ...
        <div x-show="showError" x-transition:enter="transform ease-out duration-300 transition"
            ...
            x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100"
            x-transition:leave-end="opacity-0"
            class="max-w-screen-sm w-full bg-white dark:bg-neutral-800 shadow-lg rounded-2xl pointer-events-auto ring-1 ring-black ring-opacity-5 border border-danger-200 dark:border-danger-700">
            <div class="p-4">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                        <div
                    ...
                    <div class="ml-3 flex-1">
                        <p class="text-sm font-medium text-neutral-900 dark:text-neutral-100" x-text="errorMessage"></p>
                    </div>
                    <div class="ml-4 flex-shrink-0 flex">
        ...
        <div class="">
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-3 mb-2">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-neutral-600 dark:text-neutral-400">Create Test Package</h1>
                        <p class="text-neutral-600 dark:text-neutral-400">Add a new test package to the system</p>
                    </div>
                </div>
            ...
            <div class="card-mobile-lg py-10 px-10">
                <form action="{{ route('test-packages.store') }}" method="POST" x-data="{
                    isSubmitting: false,
                    handleSubmit() {
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text" name="title" id="title" value="{{ old('title') }}" required
                                class="w-full px-4 py-3 bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-600 rounded-xl text-neutral-900 dark:text-neutral-100 placeholder-neutral-500 dark:placeholder-neutral-400 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 tap-highlight-none @error('title') border-danger-500 focus:ring-danger-500 focus:border-danger-500 @enderror"
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="description" id="description" required rows="4"
                            class="w-full px-4 py-3 bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-600 rounded-xl text-neutral-900 dark:text-neutral-100 placeholder-neutral-500 dark:placeholder-neutral-400 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 resize-none tap-highlight-none @error('description') border-danger-500 focus:ring-danger-500 focus:border-danger-500 @enderror"
                            placeholder="Describe the test package content and objectives">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-sm text-danger-600 dark:text-danger-400 flex items-center space-x-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="number" name="duration_minutes" id="duration_minutes"
                                    ...
                                    class="w-full px-4 py-3 bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-600 rounded-xl text-neutral-900 dark:text-neutral-100 placeholder-neutral-500 dark:placeholder-neutral-400 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 tap-highlight-none @error('duration_minutes') border-danger-500 focus:ring-danger-500 focus:border-danger-500 @enderror"
                                    placeholder="120">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="number" name="passing_score" id="passing_score"
                                    value="{{ old('passing_score') }}" min="0" max="650" required
                                    class="w-full px-4 py-3 bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-600 rounded-xl text-neutral-900 dark:text-neutral-100 placeholder-neutral-500 dark:placeholder-neutral-400 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 tap-highlight-none @error('passing_score') border-danger-500 focus:ring-danger-500 focus:border-danger-500 @enderror"
                                    placeholder="70">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    ...
                    <div
                        ...
                        <button type="submit" :disabled="isSubmitting"
                            ...
                            <span x-text="isSubmitting ? 'Creating...' : 'Create Test Package'"></span>
                        </button>
